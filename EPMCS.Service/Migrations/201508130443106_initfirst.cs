                ...
                c => new
                    {
                        ...
                        CustomerId = c.String(nullable: false, maxLength: 75, unicode: false, storeType: "nvarchar"),
                        DeviceId = c.String(nullable: false, maxLength: 75, unicode: false, storeType: "nvarchar"),
                        DeviceCd = c.String(nullable: false, maxLength: 75, unicode: false, storeType: "nvarchar"),
                ...
                c => new
                    {
                        ...
                        DeviceId = c.String(nullable: false, maxLength: 75, unicode: false, storeType: "nvarchar"),
                        DeviceCd = c.String(nullable: false, maxLength: 75, unicode: false, storeType: "nvarchar"),
                        DeviceName = c.String(maxLength: 600, unicode: false, storeType: "nvarchar"),
                        FDeviceId = c.String(maxLength: 75, unicode: false, storeType: "nvarchar"),
                        ...
                        Port = c.String(maxLength: 75, unicode: false, storeType: "nvarchar"),
                        DeviceAdd = c.String(maxLength: 120, unicode: false, storeType: "nvarchar"),
                        Message = c.String(maxLength: 4096, unicode: false, storeType: "nvarchar"),
                        ComputationRule = c.String(maxLength: 600, unicode: false, storeType: "nvarchar"),
